...
def post_360_dialog_intro_message(
    destinatary: str, index: str, d360_number: str, destinatary_history: str
):
    """
...
def post_360_dialog_error_message(destinatary: str, index: str, d360_number: str):
    """
    ...
    Args:
        ...
        d360_number (str): The chatbot's number.
    """
    error_message = get_index_information(index, "default_message")
